...
import { FolderIcon, FileIcon } from '@/app/components/content-renderer/ui/Icons'
...
export default function DirectoryListing({ contents, currentPath }: DirectoryListingProps) {
  ...
  const filteredContents = sortedContents.filter(item => 
    item.name !== 'README.md' && !item.name.startsWith('.')
  );
